...
subprojects {
    ...
    repositories {
        ...
        maven {
            ...
            credentials {
                username = project.findProperty("gpr.user") as String? ?: System.getenv("EDC_CORE_GITHUB_ACTOR")
                password = project.findProperty("gpr.key") as String? ?: System.getenv("EDC_CORE_GITHUB_TOKEN")
            }
        }
    }
